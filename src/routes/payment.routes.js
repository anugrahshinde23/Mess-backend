...
import { createPaymentFromUser, getPaymentHistoryForUser, verifyPaymentByAdminForUser } from '../controllers/payment.controllers.js'
...
router.get('/get-pending-payments', verifyJWT, allowedRoles('ADMIN') ,verifyPaymentByAdminForUser)
